...
Yet, to truly be able to optimize the software engineering process a more holistic view and marry both the technical and social aspects.\todo{introduce STC}

\todo{Give an example of STC at work}

\todo{describe the benefits of using STC}

\todo{what has been done with respect to STC}

\todo{what did we plan to do with STC}

\todo{what are some key results we obtained}

\todo{In the remainder of this thesis}