...
teams (e.g.~\cite{Grinter:1999geography,Herbsleb:1999ew,Souza:2004wu}). This
...
communication structures in determining coordination ease~\cite{Hinds:2006xr} and
success~\cite{Hossain:2006oz}. Although there has been some research on the
...
coordinate~\cite{Hossain:2006oz} and R\&D teams with dense communication
structures are associated with more coordination problems~\cite{Hinds:2006xr}. In
...
development~\cite{bird:2006msr}. In software engineering research, however it is
...
\cite{Herbsleb:2003oo,Holmstrom:2006gd} and which gathered information about
...
management~\cite{Frost:2007ff}. Our two step study revealed the following: Our
...
success~\cite{Curtis:1988fieldstudy,kraut:1995coordination}. The dynamic nature
...
invisible~\cite{Damian:2007tz}. Moreover, team communication patterns are
significantly affected by distance~\cite{Hinds:2006xr}. Maintaining
...
maintaining personal cross-site relationships is challenging~\cite{Hinds:2006xr}.
...
projects~\cite{Curtis:1988fieldstudy}. A study by Herbsleb et
...
example, Fussell et al.~\cite{Fussell:CSCW98} found that communication amount and
...
integration~\cite{Grinter:1999geography,Souza:2004qy}. Coordination
...
(e.g.~\cite{Hossain:2006oz,Hinds:2006xr}) and a number of common measures of
...
to coordination ease~\cite{Hinds:2006xr}, coordination
capability~\cite{Hossain:2006oz} and enhanced group
...
web~\cite{Gloor:2003cikm}. Similarly, Hossain et al.~\cite{Hossain:2006oz}
...
influence'' in the
network(e.g.~\cite{Gloor:2003cikm,zimmermann-icse-2008,Hossain:2006oz}).
...
failures~\cite{nagappan:2006icse,basili:1996tse,denaro:2002seke}, though the
...
Only few studies, such as Hassan and Zhang~\cite{hassan:2006ase}, stepped away
...
failures~\cite{pinziger:2008fse,meneely:2008fse}. In our work, we focus on the
...
%the collaboration, meaning they use code metrics~\cite{nagappan:2006icse} or
...
development project, IBM's Jazz~\cite{Frost:2007ff}. With collaboration support
...
by~\cite{Gloor:2003cikm,Hinds:2006xr}.
...
Ball~\cite{Nagappan:2005vl}, one might expect that increased size and complexity
