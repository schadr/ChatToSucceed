...
\end{description}
Of course there are still ``refular'' software developers that are less involved in cross-component issues unless when they are part of a cross-component teams to implement a feature that is similar across several components.
...
These stories are then estimated and distributed across the six week iterations within a release cycles with a major milestone around the IBM Rational's Innovate conference\footnote{} to show case the latest version of IBM Rational Team Concert. 
