...
In the remainder of this chapter, we start with detailing the study design that is relevant to exploring our research question (Section~\ref{sec:studydesign}).
Then, we present the findings we obtained in Section~\ref{sec:findings} followed by some general recommender system design guidelines derived from the results and threats to validity in Section~\ref{sec:sub:tools} and Section~\ref{sec:threats} respectively.
...
TODO: discuss in greater detail how the findings answer the research question
