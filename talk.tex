...
As Murphy and Murphy-Hill~\cite{murphy:rsse:2010} pointed out recommendations are of little use if developers reject them.
...
Our participant-observation data confirm this. At one point, we needed to set up and test a specific component in the RTC product. The development team in charge of that component was located on a different site. However, since Adrian had previously had the opportunity to establish relationships with some of the developers of that team through a previous research study, it was easier for him to contact them and ask for help in his setup task.
