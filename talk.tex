...
Therefore we pursue to answer \textbf{RQ 2.2:} \emph{Does recommending at the lowest level make sense?} and \textbf{RQ 2.3:} \emph{When does recommending on the lowest level make sense?}



\section{TODO Study Design}
...
First, the first author of this paper (Adrian) was embedded in a sub-team of the RTC team as a participant-observer for four months.
...
\subsection{TODO Data Collection}
...
\subsubsection{TODO Participant-Observation}
...
\section{TODO Recommender System Design Guidelines}
\label{sec:sub:tools}
...
\section{TODO Threats to Validity}
\label{sec:threats}
