...
For example,\todo{some examples from literature}  
...
% item 2
\item[Improving socio-technical congruence.]

% item 3
\item[Are all technical dependencies communication needs?]

% item 4
\item[How to make socio-technical congruence actionable?]

\end{description}

% some of the findings as a teaser

Before setting the stage of the thesis 
