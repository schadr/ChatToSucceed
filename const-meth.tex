...
% make clear that this is something more specific to that period
...
% acknowledge the downsides of being a participant

% emphasize trust with respect to surveys and interview

% sentence about that there is no clear separation between employing the different methods.
