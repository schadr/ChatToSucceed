...
The concept of socio-technical congruence, when studies as the match between actual coordination among a development team with the coordination needs represented by source code dependencies among source code software developers changed, shows a correlation with productivity.%~\cite{cataldo:cscw:2006}.
