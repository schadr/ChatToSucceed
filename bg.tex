...
Each entry in the task dependecy matrix indicated whether two tasks have a dependecy, note that non-zero entries refer to the existence of a dependency but not its strength.
...
\right)
\]
\caption{Calculating technical dependecies among developer using the task assignment and task dependency matrix.}
