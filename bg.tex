...
%
The creation of separate matrices is motivated originated from the need to extract information from different data repositories.
...
Developer centric networks that show for a speciﬁc developer what social, technical, or socio-technical relationships she has with her colleagues complement these task centric socio-technical networks.
