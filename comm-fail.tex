...
\label{chap:soc-net}
We open our investigation of how to modify the social relationships among software developers, represented by the communication among them, by searching for a relationship between communication and build success.
...
and $C_D(c_i)$ are the degree centrality measures of node $c_i$ as
described above. $C_D(c^*)$ is the largest InOut-Degree for the set of
