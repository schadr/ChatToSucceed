...
In this thesis we the studies we presented draw information from observational studies (Chapter~\ref{chap:talk} and~\ref{chap:actionable}) and studies relying on development repositories (Chapter~\ref{chap:soc-net},~\ref{chap:stc-net2}, and~\ref{chap:stc-net}).
