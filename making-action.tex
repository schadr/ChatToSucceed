...
%% yes we did, we found build failures that could have been prevented using recommendations generated from the data we gathered potentially in real time
% what is the answer to our research question
% why is this answer appropriate
% what are the threats to validity
%% course project not real development
%% looked only for anecdotal evidence
%%% build failures that might not happen in real life
