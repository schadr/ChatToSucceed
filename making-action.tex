...
We showed that gaps have a negative influence on the project~\cite{kwan:tse:2011} as well as that there are specific gaps that correlate to build failure (Chapter~\ref{chap:stc-net}). 
