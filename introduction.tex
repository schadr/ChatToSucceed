...
For example the US software industry in 2002 produced according to the US Census a total revenue of 103.7 billion USD.\footnote{http://www.census.gov/prod/ec02/ec0251i06.pdf last visited May 10th, 2012}.
...
In a follow up study we demonstrated that we can generate relevant recommendations that exhibit a strong influence on build success (cf. Chapter~\ref{chap:soc-net}).
...
The first study, to the best of our knowledge, we were the first to show a definitive relationship between coordination structure of a development team and build outcome (Chapter~\ref{chap:soc-net}).
...
Finally, in a case study of a large student project at the University of Victoria, Canada, and Aalto University, Finland, we showed that data needed to compute socio-technical network can be collected in real time while a developer is editing her source code (cf. Chapter~\ref{chap:actionable}).
...
Before concluding this dissertation with discussing how our approach to leverage socio-technical congruence (cf. Chapter~\ref{chap:disc}) is supported by the evidence uncovered through our studies, we present a study in Chapter~\ref{chap:actionable} which showed evidence that 
