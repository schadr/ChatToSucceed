...
In Chapter~\ref{chap:meth} Figure~\ref{fig:network} we showed how we conceptualized social network and how defining software builds as our scope we omit several artifacts related to communication from the construction of a social network for a specific build.
